            ...
            */
            ...
            $.each(this.formats, function (formatPriority, format) {
                ...
                $.each(self.solutions, function (solutionPriority, solution) {
                    var validstring = self._validString(media[format]);
                    var stringTest = self[solution].support[format];
                    if (stringTest && validstring) { // Format supported in solution and url given for format.
